...
----------    GLOBAL DATA     ------------
*****************************************/
static u8 Keypad_Array[Keypad_ROWS_SIZE][Keypad_COLUMNS_SIZE]=Keypad_Layout;
static u8 Keypad_Columns[Keypad_COLUMNS_SIZE]=Keypad_Columns_Pins;
static u8 Keypad_Rows[Keypad_ROWS_SIZE]=Keypad_Rows_Pins;
/********************************************************************
...
u8 HAL_Keypad_Get_Key(void)
{
     ...
     for(Column_Counter=ZERO;Column_Counter<Keypad_COLUMNS_SIZE;Column_Counter++)
     {
          MCAL_GPIO_Write_Pin(Keypad_Port,Keypad_Columns[Column_Counter],LOW);
          for(Row_Counter=ZERO;Row_Counter<Keypad_ROWS_SIZE;Row_Counter++)
          {
...
void HAL_Keypad_Initialization(void)
{
     ...
     for(Pin_Counter=Pin_0;Pin_Counter<Keypad_ROWS_SIZE;Pin_Counter++)
     {
     ...
     for(Pin_Counter=Pin_0;Pin_Counter<Keypad_COLUMNS_SIZE;Pin_Counter++)
     {
